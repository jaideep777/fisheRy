...
fleet$effort_constantC(2.83e-6, 0.75, ssb_nf)*fleet$par$dsea
fleet$effort_constantF(2.83e-6, 0.75, ssb_nf)*fleet$par$dsea
...
pc_error = function(i, mode, h, slope){
  ...
  data.frame(
    err = df %>% 
        ...
        pull(yield_err_pc) %>% 
        tail(1),
    effort_c = fleet$effort_constantC(2.83e-6, 0.75, ssb_nf)*fleet$par$dsea,
    effort_f = fleet$effort_constantF(2.83e-6, 0.75, ssb_nf)*fleet$par$dsea
  )
}
```
