...
tibble(length = seq(0,200,length.out=100)) %>%
  mutate(mort = 0.6901/(1+exp(-0.06517*(length-68.81))) - 0.4381674/(1+exp(-0.4151*(length-112.8))) ) %>% 
  ggplot(aes(y=mort, x=length))+geom_line(col="red", size=2)+labs(x="Length", y="Fishing selectivity", col="Temp")+theme_classic(base_size = 20)

dat_full %>% 
  mutate(sel = 0.6901/(1+exp(-0.06517*(length-68.81))) - 0.4381674/(1+exp(-0.4151*(length-112.8))) ) %>% 
