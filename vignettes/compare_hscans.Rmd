...
re_simulate = re_simulate | !file.exists("outputs/res_ibm_scan_h.Rdata")
```
...
Then we create a population an spin it up under no-fishing conditions.
...
Then, we create a simulator with this prototype population, which will simulate a populations under various conditions.
...
if(re_simulate){
  res_ibm_full = sim$simulate_multi_2d(pop, c(5.61), c(45), hvec, nsteps, 1.93e3, F)
