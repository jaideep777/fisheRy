...
## Computations of Fref etc

```{r}
Fref_vec = pop$fishingMortRefByAge()
Mort_vec = pop$naturalMortByAge(5.61)
Mat_vec = pop$maturityByAge()

cbind(Fref_vec, Mort_vec, Mat_vec)[5:10,]

F_5_10 = pop$avgOverAges(Fref_vec, 5, 10, -1e20)
M_5_10 = pop$avgOverAges(Mort_vec, 5, 10, -1e20)
Ma_5_10 = pop$avgOverAges(Mat_vec, 5, 10, -1e20)

cbind(F_5_10, M_5_10, Ma_5_10)
