---
title: "Safe operating spaces 2D (with Evolution)"
...
sim$equilibriateNaturalPopulation(params_file, 5.61, 5e6)
...
```{r}
plot(c(res_ibm_sq$ssb, res_ibm$ssb)~seq(1,nsteps_sq+nsteps), type="l", col="cyan3")
abline(v = 500)
```
